...
- **API Calls**: When you look up a word, we may send the word to:
  - Free Dictionary API (dictionaryapi.dev) - for word definitions
  - OpenAI API (if you provide your own API key) - for enhanced explanations
- **Incognito Mode**: In incognito/private browsing mode, we do not save any data

## Third-Party Services

- **Free Dictionary API**: We use dictionaryapi.dev to fetch word definitions. This service may receive the words you search for.
- **OpenAI API**: If you provide your own OpenAI API key, word lookups may be sent to OpenAI. We do not store or have access to your API key.

## Data Security

- All data is stored locally in your browser
- We do not transmit your browsing data to our servers
